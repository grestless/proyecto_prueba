    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-6">
      <Card className="max-w-md w-full border-forest-800/50 bg-zinc-900/50 backdrop-blur-sm">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-3xl text-forest-300">Orden exitosa!</CardTitle>
        </CardHeader>
        <CardContent className="text-center space-y-6">
          <div className="space-y-2">
            <p className="text-forest-400">Gracias por su compra!</p>
            <p className="text-sm text-forest-400/70">Su pedido ha sido confirmado y se enviará pronto.</p>
            {params.order_id && (
              <p className="text-xs text-forest-500 font-mono bg-forest-950/50 p-2 rounded">
                Orden ID: {params.order_id}
              </p>
            )}
          </div>
